 ...
 * <p>@description: 数据库方言，针对不同数据库分别实现 </p>
 * <p>@author: Arise Tang </p>
 * <p>@create: 2020-04-19 17:29 </p>
 **/
...
public interface Dialect {
     ...
     * 跳过count和分页查询
     *
     * @param id              执行的MyBatis 方法全名
     * @param parameterObject 方法参数
     * @param rowBounds       分页参数
     * @return true跳过，返回默认查询结采，false则执行分页查询
     */
    boolean skip(String id, Object parameterObject, RowBounds rowBounds);
    ...
    /**
     * 分页查询后，处理分页结采，拦截器中直接return该方法的返回值
     *
